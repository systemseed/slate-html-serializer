(function (global, factory) {
	...
	(factory((global.SkorzhSlateHtmlSerializer = {}),global.React,global.ReactDOMServer,global.typeOf,global.Slate,global.Immutable));
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.serializeNode = function (node) {
    if (node.object === 'text') {
      ...
      var _children = leaves.map(_this.serializeLeaf);
    ...
    try {
      for (var _iterator2 = _this.rules[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        var ret = rule.serialize(node, children.toArray());
        if (ret === null) return;
